...
type TurnType = "straight" | "left" | "right" | "slight-left" | "slight-right" | "arrive" | "depart";
...
const ROUTE: Route = {
  ...
  steps: [
    { id: 1, turn: "depart",       instruction: "Head north",      street: "Hacker Way",        distance: "0.2 mi",  duration: "1 min"  },
    { id: 2, turn: "right",        instruction: "Turn right",       street: "Willow Rd",         distance: "0.8 mi",  duration: "2 min"  },
    { id: 3, turn: "slight-left",  instruction: "Slight left",      street: "US-101 N",          distance: "14.2 mi", duration: "16 min" },
    { id: 4, turn: "left",         instruction: "Take exit 430B",   street: "I-80 E",            distance: "5.4 mi",  duration: "8 min"  },
    { id: 5, turn: "straight",     instruction: "Continue on",      street: "Bay Bridge",        distance: "4.5 mi",  duration: "6 min"  },
    { id: 6, turn: "right",        instruction: "Turn right",       street: "Fremont St",        distance: "0.9 mi",  duration: "3 min"  },
    { id: 7, turn: "slight-right", instruction: "Slight right",     street: "The Embarcadero",   distance: "2.1 mi",  duration: "4 min"  },
    { id: 8, turn: "arrive",       instruction: "Arrive at",        street: "Ferry Building",    distance: "",        duration: ""       },
  ],
};
...
export default function DirectionsCardRC() {
  ...
  const modes = [
    { id: "driving" as const, label: "Drive",
      icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v9a2 2 0 0 1-2 2h-2"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="16.5" cy="17.5" r="2.5"/></svg>,
    },
    { id: "walking" as const, label: "Walk",
      icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="5" r="2"/><path d="M5 22l2-8 4 2 4-2 2 8"/><path d="M8 14l-2 8M16 14l2 8"/></svg>,
    },
    { id: "cycling" as const, label: "Bike",
      icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="5.5" cy="17.5" r="3.5"/><circle cx="18.5" cy="17.5" r="3.5"/><path d="M15 6a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-3 11.5V14l-3-3 4-3 2 3h3"/></svg>,
    },
  ];
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-[11px] text-[#e6edf3] font-semibold truncate">{ROUTE.destination}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 pl-4">
                ...
                <span className="ml-auto text-[10px] text-green-400 font-semibold">Fastest route</span>
              </div>
            </div>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center flex-shrink-0">
                    ...
                    >
                      <TurnIcon type={step.turn} active={isActive || step.turn === "arrive" || step.turn === "depart"} />
                    </div>
                    {!isLast && (
                      <div
                  ...
                  <div className="flex-1 min-w-0 pt-1">
                    <p className={`text-[12px] font-semibold ${isActive ? "text-[#e6edf3]" : "text-[#8b949e]"}`}>
                      {step.instruction}{" "}
                      <span className={`font-bold ${isActive ? "text-[#58a6ff]" : "text-[#e6edf3]"}`}>{step.street}</span>
                    </p>
