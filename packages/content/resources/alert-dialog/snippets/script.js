(() => {
  ...
  // Wire open triggers
  document.getElementById('open-delete').addEventListener('click', () => openDialog(document.getElementById('dialog-delete')));
  document.getElementById('open-logout').addEventListener('click', () => openDialog(document.getElementById('dialog-logout')));
  document.getElementById('open-revoke').addEventListener('click', () => openDialog(document.getElementById('dialog-revoke')));
