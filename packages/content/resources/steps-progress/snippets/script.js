(function () {
  var STEPS = [
    { title: "Create your account",   desc: "Enter your email and choose a secure password to get started." },
    { title: "Personal details",       desc: "Tell us your name, location, and a bit about yourself." },
    { title: "Payment information",    desc: "Add a payment method — you won't be charged until you confirm." },
    { title: "Review and confirm",     desc: "Double-check your details. Everything looks good? Let's go!" }
  ];
