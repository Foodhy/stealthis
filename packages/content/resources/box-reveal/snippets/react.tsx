...
export default function BoxRevealDemo() {
  return (
    <div style={{ background: "#0a0a0a", minHeight: "300vh", fontFamily: "system-ui, -apple-system, sans-serif", color: "#e2e8f0" }}>
      ...
      <section style={{ maxWidth: 800, margin: "0 auto", padding: "4rem 2rem", display: "flex", flexDirection: "column", gap: "4rem" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <BoxReveal color="#818cf8" delay={0}>
            <span style={{ fontSize: "1.25rem", fontWeight: 600, color: "#818cf8" }}>Introducing</span>
          </BoxReveal>
          <BoxReveal color="#818cf8" delay={200}>
            <h2 style={{ fontSize: "clamp(1.5rem, 4vw, 2.5rem)", fontWeight: 800, color: "#f1f5f9", letterSpacing: "-0.02em" }}>
              Box Reveal Effect
            </h2>
          </BoxReveal>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <BoxReveal color="#f472b6">
            <h2 style={{ fontSize: "clamp(1.5rem, 4vw, 2.5rem)", fontWeight: 800, color: "#f1f5f9" }}>
              Custom Colors
            </h2>
          </BoxReveal>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "1.5rem" }}>
          <BoxReveal color="#34d399">
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "2rem" }}>
              <h3 style={{ fontSize: "1.25rem", fontWeight: 700, color: "#f1f5f9", marginBottom: "0.5rem" }}>Fast</h3>
              <p style={{ color: "rgba(148,163,184,0.8)", lineHeight: 1.7, fontSize: "0.95rem" }}>Pure CSS animations with no JavaScript overhead during the transition.</p>
            </div>
          </BoxReveal>
          <BoxReveal color="#fbbf24" delay={200}>
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "2rem" }}>
              <h3 style={{ fontSize: "1.25rem", fontWeight: 700, color: "#f1f5f9", marginBottom: "0.5rem" }}>Flexible</h3>
              <p style={{ color: "rgba(148,163,184,0.8)", lineHeight: 1.7, fontSize: "0.95rem" }}>Works with any content — text, cards, images, or entire sections.</p>
            </div>
          </BoxReveal>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
          <BoxReveal color="#a78bfa">
            <span style={{ fontSize: "1.25rem", fontWeight: 600, color: "#a78bfa" }}>Staggered Reveals</span>
          </BoxReveal>
          <BoxReveal color="#a78bfa" delay={200}>
            <h2 style={{ fontSize: "clamp(1.5rem, 4vw, 2.5rem)", fontWeight: 800, color: "#f1f5f9" }}>Cascading Wipe</h2>
          </BoxReveal>
