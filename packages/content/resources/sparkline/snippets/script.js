...
document.querySelectorAll('.sl-row[data-values]').forEach(row=>{
  ...
  area.setAttribute('d',areaD);area.setAttribute('fill',`url(#sg_${color.replace('#','')})`);
  ...
  dot.setAttribute('fill',color);dot.setAttribute('stroke','#0f1117');dot.setAttribute('stroke-width','1.5');
  svg.appendChild(dot);
