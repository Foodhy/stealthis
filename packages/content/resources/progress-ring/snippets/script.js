...
function buildRing(wrap){
  ...
  track.setAttribute('stroke-width',STROKE);track.classList.add('ring-track');
  svg.appendChild(track);

  // Fill
  const fill=document.createElementNS('http://www.w3.org/2000/svg','circle');
  fill.setAttribute('cx',cx);fill.setAttribute('cy',cy);fill.setAttribute('r',R);
  fill.setAttribute('stroke-width',STROKE);fill.setAttribute('stroke',color);
  ...
  pct.setAttribute('text-anchor','middle');pct.setAttribute('font-size','20');
  ...
  lbl.setAttribute('text-anchor','middle');lbl.classList.add('ring-lbl');
