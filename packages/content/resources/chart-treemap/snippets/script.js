const DATA = [
  { label: 'Technology', color: '#818cf8', children: [
    {label:'NVDA',value:320},{label:'AAPL',value:280},{label:'MSFT',value:240},{label:'GOOGL',value:200}
  ]},
  { label: 'Finance', color: '#34d399', children: [
    {label:'JPM',value:180},{label:'BAC',value:140},{label:'GS',value:120}
  ]},
  { label: 'Healthcare', color: '#f59e0b', children: [
    {label:'JNJ',value:160},{label:'UNH',value:130},{label:'PFE',value:90}
  ]},
  { label: 'Energy', color: '#f87171', children: [
    {label:'XOM',value:150},{label:'CVX',value:110}
  ]},
  { label: 'Consumer', color: '#a78bfa', children: [
    {label:'AMZN',value:200},{label:'WMT',value:130}
  ]},
];
...
function squarify(items, x, y, w, h) {
  ...
  while(remaining.length) {
    ...
    for(let i=0;i<remaining.length;i++){
      ...
      if(isHoriz){x+=rowLen2;w-=rowLen2;}
      else{y+=rowLen2;h-=rowLen2;}
      break;
    }
...
function render(){
  ...
  laid.forEach((d,i)=>{
    ...
    tile.addEventListener('mousemove',e=>{tooltip.style.left=(e.clientX+12)+'px';tooltip.style.top=(e.clientY-40)+'px';});
