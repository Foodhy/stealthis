...
function showTyping() {
  ...
  el.id = 'typing';
  el.innerHTML = '<div class="msg-av">SH</div><div class="typing-indicator"><div class="typing-dot"></div><div class="typing-dot"></div><div class="typing-dot"></div></div>';
...
launcher?.addEventListener('click', () => {
  ...
  if (!opened && !isOpen) {
    opened = true;
    setTimeout(() => addMessage('Hi! 👋 Welcome to StealthHelp. How can I assist you today?', false), 300);
  }
});
