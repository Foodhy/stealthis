const VIDEOS = [
  { id: 1, title: 'Building a Full-Stack App with Next.js 14', category: 'tutorials', views: '142K', duration: '42:18', gradient: 'linear-gradient(135deg,#1a1a2e,#16213e)' },
  { id: 2, title: 'The Future of AI in Software Engineering', category: 'talks', views: '98K', duration: '28:05', gradient: 'linear-gradient(135deg,#0f3460,#533483)' },
  { id: 3, title: 'CSS Tips You Wish You Knew Sooner', category: 'shorts', views: '215K', duration: '0:58', gradient: 'linear-gradient(135deg,#2d1b69,#11998e)' },
  { id: 4, title: 'TypeScript Generics Deep Dive', category: 'tutorials', views: '76K', duration: '35:22', gradient: 'linear-gradient(135deg,#1e3c72,#2a5298)' },
  { id: 5, title: 'Designing for Accessibility First', category: 'talks', views: '54K', duration: '22:44', gradient: 'linear-gradient(135deg,#134e5e,#71b280)' },
  { id: 6, title: 'One CSS Trick to Rule Them All', category: 'shorts', views: '403K', duration: '0:45', gradient: 'linear-gradient(135deg,#4a1942,#c74b50)' },
  { id: 7, title: 'Docker for Frontend Developers', category: 'tutorials', views: '63K', duration: '19:30', gradient: 'linear-gradient(135deg,#0f2027,#2c5364)' },
  { id: 8, title: 'The Psychology of Code Reviews', category: 'talks', views: '88K', duration: '31:12', gradient: 'linear-gradient(135deg,#373b44,#4286f4)' },
];
...
document.getElementById('vpPlay').addEventListener('click', () => {
  ...
  if (playing) {
    progressInterval = setInterval(() => {
      ...
      if (progressPct >= 100) { stopProgress(); playing = false; document.getElementById('vpPlay').textContent = '▶'; }
    }, 100);
  } else {
    stopProgress();
  }
