(function () {
  var invoiceData = [
    {
      id: "INV-001", client: "Acme Corp", clientAddr: "Acme Corp\naccounts@acme.com\n456 Business Ave, NY 10001",
      issued: "Mar 1, 2026", due: "Mar 15, 2026", status: "Paid", paymentInfo: "via Bank Transfer on Mar 10, 2026",
      items: [
    ...
    {
      id: "INV-002", client: "Globex Inc", clientAddr: "Globex Inc\nbilling@globex.io\n789 Market St, SF 94103",
      issued: "Mar 3, 2026", due: "Mar 17, 2026", status: "Paid", paymentInfo: "via Credit Card on Mar 12, 2026",
      items: [
    ...
    {
      id: "INV-003", client: "Wayne Enterprises", clientAddr: "Wayne Enterprises\nfinance@wayne.com\n1 Gotham Plaza, Gotham 12345",
      issued: "Mar 5, 2026", due: "Mar 19, 2026", status: "Pending", paymentInfo: "Awaiting payment",
      items: [
    ...
    {
      id: "INV-004", client: "Stark Industries", clientAddr: "Stark Industries\nap@stark.ind\n200 Park Avenue, NY 10166",
      issued: "Feb 15, 2026", due: "Mar 1, 2026", status: "Overdue", paymentInfo: "Payment overdue since Mar 1, 2026",
      items: [
    ...
    {
      id: "INV-005", client: "Umbrella Corp", clientAddr: "Umbrella Corp\npayables@umbrella.co\n10 Raccoon Drive, Midwest 55123",
      issued: "Mar 8, 2026", due: "Mar 22, 2026", status: "Paid", paymentInfo: "via PayPal on Mar 15, 2026",
      items: [
    ...
    {
      id: "INV-006", client: "Initech LLC", clientAddr: "Initech LLC\nbilling@initech.com\n4120 Freidrich Lane, Austin TX 78744",
      issued: "Mar 10, 2026", due: "Mar 24, 2026", status: "Pending", paymentInfo: "Awaiting payment",
      items: [
    ...
    {
      id: "INV-007", client: "Soylent Corp", clientAddr: "Soylent Corp\nfinance@soylent.co\n77 Green St, Portland OR 97201",
      issued: "Mar 12, 2026", due: "Mar 26, 2026", status: "Cancelled", paymentInfo: "Invoice cancelled on Mar 14, 2026",
      items: [
        { desc: "Logo Design", qty: 1, rate: 150 }
      ]
    },
    {
      id: "INV-008", client: "Massive Dynamic", clientAddr: "Massive Dynamic\nar@massivedynamic.com\n1 Science Way, Boston MA 02210",
      issued: "Mar 15, 2026", due: "Mar 29, 2026", status: "Paid", paymentInfo: "via Wire Transfer on Mar 18, 2026",
      items: [
  ...
  function openModal(idx) {
    ...
    document.getElementById("invDates").innerHTML = "Issued: " + inv.issued + "<br/>Due: " + inv.due;
