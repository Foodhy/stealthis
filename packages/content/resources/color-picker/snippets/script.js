(function () {
  ...
  document.addEventListener('mouseup', function () { draggingCanvas = false; });
  ...
  document.addEventListener('touchmove', function (e) {
    if (draggingCanvas) { pickFromCanvas(e.touches[0]); e.preventDefault(); }
  }, { passive: false });
  document.addEventListener('touchend', function () { draggingCanvas = false; });
  ...
  hueTrack.addEventListener('mousedown', function (e) { draggingHue = true; pickHue(e); });
  ...
  hueTrack.addEventListener('touchstart', function (e) {
    draggingHue = true; pickHue(e.touches[0]); e.preventDefault();
  }, { passive: false });
  document.addEventListener('touchmove', function (e) {
    if (draggingHue) { pickHue(e.touches[0]); e.preventDefault(); }
  }, { passive: false });
  document.addEventListener('touchend', function () { draggingHue = false; });
  ...
  opTrack.addEventListener('mousedown', function (e) { draggingOp = true; pickOpacity(e); });
  document.addEventListener('mousemove', function (e) { if (draggingOp) pickOpacity(e); });
  document.addEventListener('mouseup',   function ()  { draggingOp = false; });

  opTrack.addEventListener('touchstart', function (e) {
    draggingOp = true; pickOpacity(e.touches[0]); e.preventDefault();
  }, { passive: false });
  document.addEventListener('touchmove', function (e) {
    if (draggingOp) { pickOpacity(e.touches[0]); e.preventDefault(); }
  }, { passive: false });
  document.addEventListener('touchend', function () { draggingOp = false; });
