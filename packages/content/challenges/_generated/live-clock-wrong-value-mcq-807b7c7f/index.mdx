---
slug: "live-clock-wrong-value-mcq-807b7c7f"
topic: "clock"
title: "Spot the wrong CSS value in Live Clock (Analog + Digital)"
type: "identify"
difficulty: 1
...
options:
  - "`--clock-size: 0px;` should be `--clock-size: 200px;`"
  - "The selector should be removed entirely"
  - "The declaration should use !important"
  - "Nothing is wrong"
answer: 0
explanation: "The mutated value `0px` is incorrect for this snippet."
realWorldHook: "Spot the line that caused the regression. (clock)"
