---
slug: "lg-19-view-transition-app-shell-remove-css-property-b0d37982"
topic: "imported-libs-gen"
title: "Restore missing CSS property in View Transition App Shell"
type: "fix"
difficulty: 1
...
explanation: "The declaration `--bg: #0a0f19;` was removed from the stylesheet. Add it back to recover the expected layout/behavior."
