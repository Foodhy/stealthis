---
slug: "lgc-82-uhd-nintendo-wrong-value-mcq-cce93da7"
topic: "nintendo"
title: "Spot the wrong CSS value in Nintendo UHD Console Showcase Page"
type: "identify"
difficulty: 1
...
options:
  - "`--red: #e0;` should be `--red: #e60012;`"
  - "The selector should be removed entirely"
  - "The declaration should use !important"
  - "Nothing is wrong"
answer: 0
explanation: "The mutated value `#e0` is incorrect for this snippet."
realWorldHook: "Spot the line that caused the regression. (nintendo)"
