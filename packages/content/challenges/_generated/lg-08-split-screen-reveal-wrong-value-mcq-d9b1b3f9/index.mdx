---
slug: "lg-08-split-screen-reveal-wrong-value-mcq-d9b1b3f9"
topic: "imported-libs-gen"
title: "Spot the wrong CSS value in Split Screen Reveal"
type: "identify"
difficulty: 1
...
options:
  - "`--bg: #0;` should be `--bg: #040913;`"
  - "The selector should be removed entirely"
  - "The declaration should use !important"
  - "Nothing is wrong"
answer: 0
explanation: "The mutated value `#0` is incorrect for this snippet."
