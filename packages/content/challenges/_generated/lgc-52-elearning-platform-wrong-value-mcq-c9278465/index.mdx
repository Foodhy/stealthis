---
slug: "lgc-52-elearning-platform-wrong-value-mcq-c9278465"
topic: "imported-libs-genclaude"
title: "Spot the wrong CSS value in E-Learning Platform — Meridian"
type: "identify"
difficulty: 1
...
options:
  - "`--bg: #fafbff-wrong;` should be `--bg: #fafbff;`"
  - "The selector should be removed entirely"
  - "The declaration should use !important"
  - "Nothing is wrong"
answer: 0
explanation: "The mutated value `#fafbff-wrong` is incorrect for this snippet."
