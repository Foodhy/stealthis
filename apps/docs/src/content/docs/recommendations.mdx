...
Recommendations compare **tools** for a need you already understand. If you're starting from a **problem** you haven't diagnosed yet ("why is this slow?", "web or native?"), begin with **[Playbooks](/playbooks/)** — the tool, if any, falls out of the diagnosis.
