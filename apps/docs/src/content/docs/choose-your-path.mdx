...
**Stuck on a specific problem instead of a goal?** ("my list is slow", "my endpoint takes seconds", "web or native app?") — start from the symptom in **[Playbooks](/playbooks/)**: diagnosis, recommendation, and the trade-offs of what was ruled out.
...
**Deciding where the product should live** (web, PWA, hybrid, or native)? Walk the constraint-driven decision tree in [Web, PWA, hybrid or native?](/playbooks/platform-choice/case-new-product/). For internal admin tools, see [An internal tool or dashboard](/playbooks/platform-choice/case-internal-tool/).
...
| Hotel / hospitality / resort | [hotel](https://stealthis.dev/library?collection=hotel) |
| Airline / flights / travel | [airline](https://stealthis.dev/library?collection=airline) |
| Coworking / studio / space rental | [cowork](https://stealthis.dev/library?collection=cowork) |
| Auto repair / dealership / garage | [auto](https://stealthis.dev/library?collection=auto) |
| Law firm / legal / attorney | [legal](https://stealthis.dev/library?collection=legal) |
| Insurance / carrier / broker | [insurance](https://stealthis.dev/library?collection=insurance) |
| Construction / contractor / trades | [construction](https://stealthis.dev/library?collection=construction) |
| Veterinary / pet care / animal clinic | [vet](https://stealthis.dev/library?collection=vet) |
| Photography studio / photographer / portfolio | [photography](https://stealthis.dev/library?collection=photography) |
| Dental clinic / dentist / orthodontics | [dental](https://stealthis.dev/library?collection=dental) |
| Wedding planner / event / celebration | [wedding](https://stealthis.dev/library?collection=wedding) |
| Podcast network / audio show / host | [podcast](https://stealthis.dev/library?collection=podcast) |
| Dating / social / matchmaking app | [dating](https://stealthis.dev/library?collection=dating) |
| Fitness coach / personal trainer | [coach](https://stealthis.dev/library?collection=coach) |
| Interior design / architecture studio | [interior](https://stealthis.dev/library?collection=interior) |
| Videographer / film studio / production | [video](https://stealthis.dev/library?collection=video) |
| DIY / maker / repair / electronics | [diy](https://stealthis.dev/library?collection=diy) |
