...
export const GET: APIRoute = async ({ site }) => {
  ...
  const content = [
    ...
    `- Russian library: ${origin}/ru/library/`,
    ...
    "- Remote MCP server, free, no API key: https://mcp.stealthis.dev/mcp (MCP Streamable HTTP, JSON-RPC over POST).",
    "- Tools: list_resources, get_resource, get_snippet, search, get_lab.",
    "- claude.ai / Claude Desktop: add as custom connector (Settings → Connectors → Add custom connector).",
    "- Claude Code: `claude mcp add stealthis --transport http https://mcp.stealthis.dev/mcp`.",
    "- Setup guide: https://mcp.stealthis.dev/ · Use cases: https://mcp.stealthis.dev/use-cases",
    "- MCP LLM context file: https://mcp.stealthis.dev/llms.txt",
    "",
