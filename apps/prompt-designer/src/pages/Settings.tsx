      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">{t("settings.themeSubtitle")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {themes.map((themeOption) => {
              ...
              return (
                <Card
                  key={themeOption.id}
                  className={`p-5 cursor-pointer transition-all duration-200 hover:border-primary/50 ${
